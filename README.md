...
- **2026-03-22** — ![NEW](https://img.shields.io/badge/NEW-red?style=flat-square) 🔍 **[Codex + Gemini critic guide](docs/CODEX_GEMINI_CRITIC_GUIDE.md)** — Codex executes, Gemini reviews via local structured review runners (`tools/run_gemini_critic.py`, `tools/run_agent_critic_loop.py`). Good fit when Codex is your easiest local executor and Gemini is your most accessible external critic. [CN](docs/CODEX_GEMINI_CRITIC_GUIDE_CN.md)
...
> **Want Codex to execute but Gemini to review locally?** See [`docs/CODEX_GEMINI_CRITIC_GUIDE.md`](docs/CODEX_GEMINI_CRITIC_GUIDE.md) and [CN](docs/CODEX_GEMINI_CRITIC_GUIDE_CN.md). This path uses lightweight repo-local runners instead of MCP review bridges.
