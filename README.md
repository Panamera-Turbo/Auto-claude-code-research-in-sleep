...
- **2026-03-22** — ![NEW](https://img.shields.io/badge/NEW-red?style=flat-square) 🔍 **[Codex + Gemini critic guide](docs/CODEX_GEMINI_CRITIC_GUIDE.md)** — Codex executes, Gemini reviews via local structured review runners (`tools/run_gemini_critic.py`, `tools/run_agent_critic_loop.py`).
